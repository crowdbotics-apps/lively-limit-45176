"""
Django settings for lively_limit_45176 project.
...
ROOT_URLCONF = 'lively_limit_45176.urls'
...
WSGI_APPLICATION = 'lively_limit_45176.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lively_limit_45176 API",
    "DESCRIPTION": "API documentation for lively_limit_45176 App",
    "VERSION": "v1",
}
